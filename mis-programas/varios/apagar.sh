...
echo -e "\n ${blueColour}Correcto ${yellowColour}$usuario${endColour}. \n${blueColour}Vamos a programar una acción para poder apagar el computador a la hora que determines.${endColour}"
echo -e "\n ${redColour}##############################################################################${endColour}"
sleep 6
clear
...
banner
echo
read -p "Escribe la cantidad de tiempo para que se apague el computador " cantidad
sleep 2
echo
helpPanel
echo
...
echo
if [ $tipo = "h" ]; then
    echo -e "${greenColour}Son las${endColour} ${naranjaColour}$hora_segundos${endColour} ${blackColour}$usuario${endColour} ${greenColour}Apagaremos en${endColour} ${blueColour}$cantidad horas${endColour}  ${redColour}presiona ctrl + c para detener${endColour}"

elif [ $tipo = "m" ]; then

    echo -e "${greenColour}Son las${endColour} ${naranjaColour}$hora_segundos${endColour} ${blackColour}$usuario${endColour} ${greenColour}Apagaremos en${endColour} ${blueColour}$cantidad minutos${endColour}  ${redColour}presiona ctrl + c para detener${endColour}"

elif [ $tipo = "s" ]; then
    echo -e "${greenColour}Son las${endColour} ${naranjaColour}$hora_segundos${endColour} ${blackColour}$usuario${endColour} ${greenColour}Apagaremos en${endColour} ${blueColour}$cantidad segundos${endColour}  ${redColour}presiona ctrl + c para detener${endColour}"
else
...
sleep $cantidad$tipo && sudo shutdow -r now
exit 0
